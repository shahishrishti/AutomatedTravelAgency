...
public class VehicleUtils {
	...
	public static Vehicle convertVehicleEntityIntoVehicle(VehicleEntity vehicleEntity) {
		return new Vehicle(vehicleEntity.getVehicleNo(), vehicleEntity.getVehicleName(), vehicleEntity.getVehicleType(), 
				vehicleEntity.getFarePerKm(), vehicleEntity.getSeatingCapacity(), vehicleEntity.getDriverEntity().getDriverId());
	}
}
